    ...
    return (
      ...
      >
        <div className="px-4 max-w-6xl w-full">
          <h2 className="text-4xl text-emerald-500 font-mono font-extrabold mb-8 text-center">CONTATO</h2>
          <div className="flex flex-col lg:flex-row justify-center items-center gap-8">
            ...
            <div className="w-full max-w-md text-center lg:text-left">
              <p className="mb-6">
                ...
                concretos. Nossa Consultoria é a escolha perfeita para tornar o seu shape
